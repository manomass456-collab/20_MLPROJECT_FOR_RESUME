...
## Resume Bullet
Built a Healthcare ML project for predict whether a patient is likely to be readmitted within 30 days. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
