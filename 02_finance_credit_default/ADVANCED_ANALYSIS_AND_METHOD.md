...
## Resume Bullet
Built a Finance ML project for estimate the probability that a loan applicant will default. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
