...
## Problem Statement
Estimate claim cost severity for faster triage.
...
## Resume Bullet
Built a Insurance ML project for estimate claim cost severity for faster triage. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
