...
## Resume Bullet
Built a Transportation ML project for predict whether a shipment will arrive late. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
