# Inventory Item Clustering

## Sector
Supply Chain

## Problem Statement
Segment inventory items by movement, cost, and risk.
...
- Train a scikit-learn model suited to the task type: `clustering`.
...
## Resume Bullet
Built a Supply Chain ML project for segment inventory items by movement, cost, and risk. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
