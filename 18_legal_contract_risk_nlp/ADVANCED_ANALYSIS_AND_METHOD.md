# Contract Risk Text Classification

## Sector
Legal

## Problem Statement
Classify contract clauses as low or high risk from text.
...
- Train a scikit-learn model suited to the task type: `nlp`.
...
## Resume Bullet
Built a Legal ML project for classify contract clauses as low or high risk from text. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
