...
## Problem Statement
Predict daily building energy usage to support efficiency planning.
...
## Resume Bullet
Built a Energy ML project for predict daily building energy usage to support efficiency planning. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
