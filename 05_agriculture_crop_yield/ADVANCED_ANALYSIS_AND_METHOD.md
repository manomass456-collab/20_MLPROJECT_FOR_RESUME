...
## Problem Statement
Predict crop yield using soil, weather, and farming input variables.
...
## Resume Bullet
Built a Agriculture ML project for predict crop yield using soil, weather, and farming input variables. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
