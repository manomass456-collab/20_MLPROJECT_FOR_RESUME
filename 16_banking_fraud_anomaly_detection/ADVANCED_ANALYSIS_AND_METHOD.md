...
## Problem Statement
Detect unusual banking transactions without relying only on labels.
...
- Train a scikit-learn model suited to the task type: `anomaly`.
...
## Resume Bullet
Built a Banking ML project for detect unusual banking transactions without relying only on labels. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
