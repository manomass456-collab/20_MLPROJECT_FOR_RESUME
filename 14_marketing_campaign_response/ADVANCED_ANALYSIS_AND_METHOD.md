...
## Problem Statement
Predict which customers will respond to a campaign.
...
## Resume Bullet
Built a Marketing ML project for predict which customers will respond to a campaign. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
