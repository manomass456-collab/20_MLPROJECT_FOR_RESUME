...
## Problem Statement
Predict hotel reservations likely to be cancelled.
...
## Resume Bullet
Built a Hospitality ML project for predict hotel reservations likely to be cancelled. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
