...
## Problem Statement
Classify network events as normal or suspicious.
...
## Resume Bullet
Built a Cybersecurity ML project for classify network events as normal or suspicious. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
