...
## Problem Statement
Predict AQI from emissions and weather variables.
...
## Resume Bullet
Built a Environment ML project for predict aqi from emissions and weather variables. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
