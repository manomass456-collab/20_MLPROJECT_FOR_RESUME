...
## Problem Statement
Identify customers likely to cancel service.
...
## Resume Bullet
Built a Telecom ML project for identify customers likely to cancel service. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
