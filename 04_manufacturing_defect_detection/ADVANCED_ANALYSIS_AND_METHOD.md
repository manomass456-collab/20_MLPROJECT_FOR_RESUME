...
## Problem Statement
Detect defective units from sensor and inspection measurements.
...
- Train a scikit-learn model suited to the task type: `classification`.
...
## Resume Bullet
Built a Manufacturing ML project for detect defective units from sensor and inspection measurements. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
