...
## Resume Bullet
Built a Human Resources ML project for predict whether an employee is likely to leave. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
