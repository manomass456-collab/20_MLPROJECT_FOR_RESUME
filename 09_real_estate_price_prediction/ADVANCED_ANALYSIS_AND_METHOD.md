...
## Problem Statement
Predict sale price using property and neighborhood signals.
...
## Resume Bullet
Built a Real Estate ML project for predict sale price using property and neighborhood signals. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
