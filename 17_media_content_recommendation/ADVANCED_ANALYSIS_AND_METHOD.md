...
## Problem Statement
Recommend similar content using user preference signals.
...
- Train a scikit-learn model suited to the task type: `recommendation`.
...
## Resume Bullet
Built a Media ML project for recommend similar content using user preference signals. using Python, pandas, and scikit-learn; packaged the dataset, training pipeline, saved model, metrics report, and explainability-ready analysis.
